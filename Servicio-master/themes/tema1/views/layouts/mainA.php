...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Angelica Landazabal">
      ...
      <div class="nav-collapse collapse pull-right">
        <?php $this->widget('zii.widgets.CMenu',array(
          ...
          'items'=>array(
            ...
            array('label'=>'Estado', 'url'=>array('/Estado'), 'visible'=>!Yii::app()->user->isGuest),
            array('label'=>'Municipio', 'url'=>array('/Municipio'), 'visible'=>!Yii::app()->user->isGuest),
            array('label'=>'Nacionalidad', 'url'=>array('/Nacionalidad'), 'visible'=>!Yii::app()->user->isGuest),
            array('label'=>'Rol', 'url'=>array('/Rol'), 'visible'=>!Yii::app()->user->isGuest),
            array('label'=>'Relacion', 'url'=>array('/Relacion'), 'visible'=>!Yii::app()->user->isGuest),
            array('label'=>'Usuario', 'url'=>array('/Usuario'), 'visible'=>!Yii::app()->user->isGuest),
