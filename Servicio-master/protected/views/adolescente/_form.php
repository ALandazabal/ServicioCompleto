...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div>
		...
		<?php echo $form->textField($model,'idAdolescente',array('placeholder'=>'Ej. 21123123')); ?>
		<?php echo $form->error($model,'idAdolescente'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'nombreA'); ?>
		<?php echo $form->textField($model,'nombreA',array('size'=>45,'maxlength'=>45, 'placeholder'=>'Ej. María')); ?>
		<?php echo $form->error($model,'nombreA'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'apellidoA'); ?>
		<?php echo $form->textField($model,'apellidoA',array('size'=>45,'maxlength'=>45, 'placeholder'=>'Ej. Mora')); ?>
