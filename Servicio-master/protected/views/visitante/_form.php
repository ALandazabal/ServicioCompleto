...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div>
		...
		<?php echo $form->textField($model,'idVisitante', array('placeholder'=>'Ej. 12123123')); ?>
		<?php echo $form->error($model,'idVisitante'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'nombreV'); ?>
		<?php echo $form->textField($model,'nombreV',array('size'=>45,'maxlength'=>45,'placeholder'=>'Ej. María')); ?>
		<?php echo $form->error($model,'nombreV'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'apellidoV'); ?>
		<?php echo $form->textField($model,'apellidoV',array('size'=>45,'maxlength'=>45, 'placeholder'=>'Ej. Mora')); ?>
		<?php echo $form->error($model,'apellidoV'); ?>
	</div>

	<div>
		<?php echo $form->labelEx($model,'direccion'); ?>
		<?php echo $form->textField($model,'direccion',array('size'=>45,'maxlength'=>45,'placeholder'=>'Ej. Pueblo Nuevo')); ?>
